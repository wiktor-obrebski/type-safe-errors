# CLAUDE.md - AI Assistant Guide for type-safe-errors
...
- 0.5.0: Added missing `resultify` export
- Improved type branding strategy recommendations
...
- Chai 4.3.6 (assertions)
- ESLint 8.20.0 + TypeScript plugin
- Prettier 2.7.1
- ts-node 10.9.1 (for running tests)
...
- **Branch:** Currently on `claude/claude-md-miiy40b3pjl4q4o4-016oL356W7FJTDRRJzZuq4sJ`
