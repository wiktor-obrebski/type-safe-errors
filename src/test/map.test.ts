import { Result, Ok, Err, Types } from '../index';
...
suite('Result map of single Ok result', () => {
  ...
  test('returns maped result for mapper with plain return', done => {
    const mapped: Types.Ok<'test-return'> = result.map((value: number) => {
  ...
  test('returns maped result for mapper with ok result return', done => {
    const mapped: Types.Ok<'test-return2'> = result.map((value: number) => {
  ...
  test('returns maped result for mapper with err result return', done => {
    ...
    const mapped: Types.Err<Error1> = result.map((value: number) => {
      return Err.of(err1);
    });
  ...
  test('returns maped result for mapper with mixed result return', done => {
    ...
    const mapped: Types.Result<'test-ok', Error1> = result.map((value: number) => {
  ...
  test('returns maped result for mapper with promise of plain return', done => {
    ...
    const mapped: Types.Ok<string> = result.map(async (value: number) => {
  ...
  test('returns maped result for mapper with promise of err result return', done => {
    ...
    const mapped: Types.Err<Error1> = result.map(async (value: number) => {
      const res = await getAsyncOk(value);
      return res;
    });
  ...
  test('returns maped result for mapper with mixed result return', done => {
    ...
    const mapped: Types.Result<'test-ok', Error1> = result.map(
      async (value: number) => {
        const res = await getAsyncOk(value);
        return res;
      }
...
suite('Result map of Err result should not be affected by', () => {
  ...
  test('mapper with plain return', done => {
    const mapped: Types.Err<Error1> = result.map((value: never) => {
      return 'test-return' as const;
    });
  ...
  test('mapper with promise of plain return', done => {
    ...
    const mapped: Types.Err<Error1> = result.map(async (value: never) => {
      const res = await getAsyncOk(value);
      return res;
    });
...
suite('Result map of mixed Ok and Err results', () => {
  type MixedResult<TValue> = Types.Ok<TValue> | Types.Err<Error1>;
  ...
  test('returns maped result for mapper with err result return', done => {
    ...
    const mapped: Types.Err<Error2> | Types.Err<Error1> = result.map(
      (value: number) => {
        return Err.of(err2);
      }
    );
  ...
  test('returns maped result for mapper with mixed result return', done => {
    ...
    const mapped: Types.Result<'test-ok', Error2 | Error1> = result.map(
      (value: number) => {
...
suite('Result map of multiple Ok results', () => {
  const result = Ok.of(5) as Types.Ok<number> | Types.Ok<string>;

  test('returns maped result for mapper with plain return', done => {
    const mapped: Types.Ok<'test-return'> = result.map((value: number | string) => {
      return 'test-return' as const;
    });
  ...
  test('returns maped result for mapper with ok result return', done => {
    const mapped: Types.Ok<'test-return2'> = result.map((value: number | string) => {
      return Ok.of('test-return2' as const);
    });
  ...
  test('returns maped result for mapper with err result return', done => {
    ...
    const mapped: Types.Err<Error1> = result.map((value: number | string) => {
      return Err.of(err1);
    });
  ...
  test('returns maped result for mapper with promise of plain return', done => {
    ...
    const mapped: Types.Ok<string> = result.map(async (value: number | string) => {
      const res = await getAsyncOk(value);
      return res;
    });
  ...
  test('returns maped result for mapper with promise of err result return', done => {
    ...
    const mapped: Types.Err<Error1> = result.map(async (value: number | string) => {
      const res = await getAsyncOk(value);
      return res;
    });
...
suite('Result map of mixed Ok and 2 Err results', () => {
  type MixedResult<TValue> = Types.Ok<TValue> | Types.Err<Error1> | Types.Err<Error2>;
  ...
  test('returns maped result for mapper with err result return', done => {
    ...
    const mapped: Types.Err<Error3> | Types.Err<Error1> | Types.Err<Error2> = result.map(
      (value: number) => {
        return Err.of(err3);
      }
    );
  ...
  test('returns maped result for mapper with mixed result return', done => {
    ...
    const mapped: Types.Result<'test-ok', Error3 | Error1 | Error2> = result.map(
      (value: number) => {
...
suite('Result map of multiple Err results should not be affected by', () => {
  const errInstance = new Error1();
  const result = Err.of(errInstance) as Types.Err<Error1> | Types.Err<Error2>;

  test('mapper with plain return', done => {
    const mapped: Types.Err<Error1> | Types.Err<Error2> = result.map((value: never) => {
      return 'test-return' as const;
    });
  ...
  test('mapper with promise of plain return', done => {
    ...
    const mapped: Types.Err<Error1> | Types.Err<Error2> = result.map(
      async (value: never) => {
        const res = await getAsyncOk(value);
        return res;
      }
...
suite('Result map of mixed 2 Ok and 2 Err results', () => {
  ...
  const result = Ok.of(5) as Types.Ok<string> | MixedResult<number>;
