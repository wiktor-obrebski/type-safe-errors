import type { Ok, Err, From, Combine } from './result-helpers';

export type { ResultNamespace, OkNamespace, ErrNamespace, From, Combine };

interface ResultNamespace {
  from<R>(result: R): From<R>;
   ...
   */
  combine<T extends readonly unknown[]>(results: [...T]): Combine<T>;
}
